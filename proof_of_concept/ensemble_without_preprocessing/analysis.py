...
for fraction in fractions:
    ...
    if len(sig_records) == 0:
        ...
        plt.tight_layout()
        plt.savefig(f"/project_antwerp/baseline/ensemble/plots/signature_overlap_ranks_{fraction}_fraction.png", dpi=150, bbox_inches="tight")
        plt.show()
    ...
    if len(paper_records) == 0:
        ...
        ax.spines[["top", "right"]].set_visible(False)
        plt.tight_layout()
        plt.savefig(f"/project_antwerp/baseline/ensemble/plots/paper_genes_overlap_ranks_{fraction}_fraction.png", dpi=150, bbox_inches="tight")
        plt.show()
