...
def _train_single_fold(
    ...
    if extract_features:
        ...
        save_path = (f'/project_antwerp/baseline/ensemble/logs/'
...
def run_baseline_training(
    ...
    if k != 25587:
        welford_gene_indices = np.load(
            f'/project_antwerp/baseline/proof_of_concept/index_files/top_{k}_genes_indices_welford_seed_{seed}.npy',
            allow_pickle=True,
        )
    ...
    index_path = '/project_antwerp/baseline/ensemble/filtered_binarylabel_indices.npy'
    index_file = np.load(index_path, allow_pickle=True)

    run_name = f'Ensemble_seed{seed}'
    wandb_config = {
        'seed':          seed,
        'k':             k,
        'L0_LAMBDA':     L0_LAMBDA,
