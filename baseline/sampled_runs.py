...
def run_raw_sampling(seed):
    ...
    log_file_path = f'/project_antwerp/baseline/averaging_baseline/logs/training_log/log_sampled_raw_{seed}.txt'
    test_metrics_path = f'/project_antwerp/baseline/averaging_baseline/logs/test_metric/metrics_sampled_raw_{seed}.txt'
    confusion_matrix_path = f'/project_antwerp/baseline/averaging_baseline/logs/CM/CM_sampled_raw_{seed}.png'
    roc_curve_path = f'/project_antwerp/baseline/averaging_baseline/logs/ROC_plot/ROC_sampled_raw_{seed}.png'
    ...
    train_sampler = PatientTileSampler(dataset_indices=train_indices, gs_to_label=gs_to_label,
...
def run_L1_sampling(seed):
    ...
    log_file_path = f'/project_antwerp/baseline/averaging_baseline/logs/training_log/log_sampled_L1_{seed}.txt'
    test_metrics_path = f'/project_antwerp/baseline/averaging_baseline/logs/test_metric/metrics_sampled_L1_{seed}.txt'
    confusion_matrix_path = f'/project_antwerp/baseline/averaging_baseline/logs/CM/CM_sampled_L1_{seed}.png'
    roc_curve_path = f'/project_antwerp/baseline/averaging_baseline/logs/ROC_plot/ROC_sampled_L1_{seed}.png'
...
def run_sig49_sampling(seed):
    ...
    log_file_path = f'/project_antwerp/baseline/averaging_baseline/logs/training_log/log_sampled_sig49_{seed}.txt'
    test_metrics_path = f'/project_antwerp/baseline/averaging_baseline/logs/test_metric/metrics_sampled_sig49_{seed}.txt'
    confusion_matrix_path = f'/project_antwerp/baseline/averaging_baseline/logs/CM/CM_sampled_sig49_{seed}.png'
    roc_curve_path = f'/project_antwerp/baseline/averaging_baseline/logs/ROC_plot/ROC_sampled_sig49_{seed}.png'
...
def run_sig157_sampling(seed):
    ...
    log_file_path = f'/project_antwerp/baseline/averaging_baseline/logs/training_log/log_sampled_sig157_{seed}.txt'
    test_metrics_path = f'/project_antwerp/baseline/averaging_baseline/logs/test_metric/metrics_sampled_sig157_{seed}.txt'
    confusion_matrix_path = f'/project_antwerp/baseline/averaging_baseline/logs/CM/CM_sampled_sig157_{seed}.png'
    roc_curve_path = f'/project_antwerp/baseline/averaging_baseline/logs/ROC_plot/ROC_sampled_sig157_{seed}.png'
